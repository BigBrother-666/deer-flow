...
.PHONY: help setup-sandbox config config-upgrade check check-agent-guidance install extension-install extension-list extension-enable extension-disable extension-remove setup doctor support-bundle detect-thread-boundaries detect-blocking-io dev dev-daemon start start-daemon nginx stop up down clean docker-init docker-start docker-stop docker-restart docker-logs docker-logs-frontend docker-logs-gateway docker-logs-redis rag-stack-up rag-stack-up-dev rag-stack-down rag-stack-restart rag-stack-logs rag-ingest-docker pg-up pg-down pg-restart pg-destroy pg-logs stack-up stack-up-dev stack-down stack-restart rag-ingest rag-serve rag-stats rag-reset langfuse-up langfuse-down langfuse-restart langfuse-logs
